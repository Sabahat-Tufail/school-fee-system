...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl overflow-hidden" style="border: 1px solid #F2D5E0; box-shadow: 0 4px 20px rgba(92,64,86,0.10);">
        <div class="px-6 py-5" style="border-bottom: 1px solid #F2D5E0; background: #FBF3F5;">
            <h3 class="text-lg font-bold" style="color: #3A2E36;">Edit Student Info</h3>
            <p class="text-xs mt-1" style="color: #7A6B72;">Modify student details and update their records.</p>
        </div>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="first_name" id="first_name" value="{{ old('first_name', $student->first_name) }}"
                           class="block w-full rounded-xl py-2.5 px-3.5 text-sm"
            ...
            <div>
                ...
                <select name="structure_id" id="structure_id"
                    ...
                    @foreach($feeStructures as $fs)
                        <option value="{{ $fs->id }}" {{ old('structure_id', $student->structure_id) == $fs->id ? 'selected' : '' }}>
